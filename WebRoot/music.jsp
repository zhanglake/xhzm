...
#div {
	...
	var rotateHTML5 = function(limit) {
		...
		var $2 = RegExp.$2;
		console.log($2);
		div.style['-webkit-transform'] = wt.replace($2, parseFloat(RegExp.$3)
				+ limit + RegExp.$4);
	}
	...
	var start = function() {
		if (!!div.interval) {
			...
			div.interval = setInterval(function() {
				/.*webkit.*/i.test(navigator.userAgent) ? rotateHTML5(1)
						: rotateIE(div);
			}, 40);
		}
	}
...
>
		...
		<div id="div" style="border-radius: 100%; -webkit-transform: rotate(10deg); background-color: #000000;">
			<div id="img">
				<img src="img/111.png" style="width: 200px; height: 200px;margin: 48px 0px;border-radius: 100%;"/>
			</div>
		</div>
	</body>
</html>